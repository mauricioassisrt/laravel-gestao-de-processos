...
<div style="background-color:#F4F4F4;">
    ...
    <![endif]-->
    <div style="background:#163029;background-color:#163029;Margin:0px auto;max-width:600px;">
    ...
    >
        <tr>
            <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
    <![endif]-->
    <div style="background:#c97d31;background-color:#c97d31;Margin:0px auto;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
               style="background:#cbcbcb;background-color:#cbcbcb;width:100%;">
            <tbody>
            <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:2px 25px;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:center;color:#ffffff;">
                                        <a style="color:#ffffff"
                                           href="{{ url('') }}" target="_blank"><b>{{ url('') }}</b></a></div>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:0px 20px;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:11px;line-height:22px;text-align:center;color:#55575d;">
